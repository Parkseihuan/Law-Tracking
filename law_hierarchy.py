...
class LawHierarchy:
    ...
    def __init__(self):
        ...
        self.categories = {
            ...
            "교육기본법": {"level": 1, "color": "#1E90FF", "description": "교육의 기본 원리와 방향"},
            "학교교육": {"level": 2, "color": "#32CD32", "description": "학교 교육 관련 법령"},
            "교원": {"level": 2, "color": "#FF8C00", "description": "교원 신분 및 처우"},
            "학교운영": {"level": 2, "color": "#9370DB", "description": "학교 설립 및 운영"},
            "학생보호": {"level": 2, "color": "#DC143C", "description": "학생 안전 및 보호"},
        ...
        self.laws = {
            ...
            "교육기본법": {
                "category": "교육기본법",
                "description": "교육의 기본 이념과 방향 제시",
                "related": ["초중등교육법", "고등교육법", "유아교육법", "평생교육법", "사립학교법"]
            },

            # 학교교육 - 학교급별
            "유아교육법": {
                "category": "학교교육",
                "description": "유치원 교육에 관한 법률",
                "related": ["교육기본법", "학교보건법", "유아교육법 시행령"]
            },
            "초중등교육법": {
                "category": "학교교육",
                "description": "초·중·고등학교 교육에 관한 법률",
                "related": ["교육기본법", "교원지위법", "학교폭력예방법", "학교보건법", "초중등교육법 시행령"]
            },
            "고등교육법": {
                "category": "학교교육",
                "description": "대학교육에 관한 법률",
                "related": ["교육기본법", "사립학교법", "고등교육법 시행령"]
            },
            "평생교육법": {
                "category": "학교교육",
                "description": "평생교육 진흥에 관한 법률",
                "related": ["교육기본법", "평생교육법 시행령"]
            },

            # 학교운영
            "사립학교법": {
                "category": "학교운영",
                "description": "사립학교 설립·운영에 관한 법률",
                "related": ["교육기본법", "고등교육법", "초중등교육법", "사립학교교직원 연금법", "사립학교법 시행령"]
            },
            ...
            "교원지위법": {
                ...
                "related": ["초중등교육법", "교육공무원법", "교원지위법 시행령"]
            },
            "교육공무원법": {
                "category": "교원",
            ...
            "학교보건법": {
                ...
                "related": ["초중등교육법", "유아교육법", "학교보건법 시행령"]
            },
    ...
    def get_law_info(self, law_name: str) -> Dict:
        ...
        # 부분 일치 시도 (예: "사립학교법" -> "사립학교법" or "사립학교법 시행령")
